// nicolen
#include "HybridVarOrderHeap.h"
#include <stdlib.h>

/* walksat */
/* Maintained by Henry Kautz <kautz@cs.rochester.edu> */
#define VERSION "walksat-v48"
...
void update_and_print_statistics_end_try(void)
{
    ...
    printf(" %9li %9i %9.2f %9.2f %9.2f %9" BIGFORMAT " %9i",
...
JNIEXPORT jboolean JNICALL Java_HybridVarOrderHeap_runWalkSat
  (JNIEnv * env, jclass class, jcharArray cnfFilename, jcharArray partialFilename, jobject infoObj) {
